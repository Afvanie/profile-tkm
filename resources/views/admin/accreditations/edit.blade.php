...
<div class="space-y-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div>
                ...
                <p class="mt-3 max-w-3xl text-slate-500 leading-7">
                    Perbarui informasi akreditasi, masa berlaku, peringkat, lembaga, nomor sertifikat, serta file sertifikat.
                </p>
            </div>
    ...
    <form id="accreditationForm"
          action="{{ route('admin.accreditations.update', $accreditation) }}"
          method="POST"
